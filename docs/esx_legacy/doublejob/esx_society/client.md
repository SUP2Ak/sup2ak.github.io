...
- <p><u>Pour commencez vous devrez ajouter ceci tout en haut du fichier :</u></p>
...
- <p><u>Vous devez remplacer entièrement tout les fonctions que vous trouverez ci-dessous :</u></p>

    <Admonition type="caution" icon="⚠️" title="Attention!"> 
        <p>Vous avez une slider pour naviguer horizontalement en dessous</p>
    </Admonition>
    <Admonition type="note" icon="📝" title="Liste des fonctions">
    <Tabs>
    <TabItem value="OpenBossMenu" label="OpenBossMenu">
    ...
    <TabItem value="OpenManageEmployeesMenu" label="OpenManageEmployeesMenu">
    ...
    <TabItem value="OpenEmployeeList" label="OpenEmployeeList">
    ...
    <TabItem value="OpenRecruitMenu" label="OpenRecruitMenu">
    ...
    <TabItem value="OpenPromoteMenu" label="OpenPromoteMenu">
    ...
    <TabItem value="OpenManageSalaryMenu" label="OpenManageSalaryMenu">
    ...
    <TabItem value="OpenManageGradesMenu" label="OpenManageGradesMenu">
